...
A kerettanterv a köznevelésről szóló 2011. évi CXC. törvény 9§ (8)-(9) bekezdésének felhatalmazása alapján a Budapest School iskola a köznevelési tevékenységét a motiváció \cite{pink2011drive}\footnote{A hivatkozások jegyzékét lásd a \pageref{sec:bibliographyk}. oldalon}, a fejlődési szemlélet \cite{growthmindset} és az elmélyült gyakorlás \cite{ericsson2016peak}  pszichológiai kutatási eredményei, az  OECD, azaz a Gazdasági Együttműködési és Fejlesztési Szervezet \emph{Az iskolázás a jövőben}  (Schooling for tomorrow) programjának eredményei \cite{2006schooling}
és modern tanulásszervezési paradigmák, mint az önvezérelt \cite{mitra2012beyond} és a személyre szabott \cite{khan2012one} tanulás. IDE VALAMI KELL
