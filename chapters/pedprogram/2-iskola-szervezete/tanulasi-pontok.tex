\section{Tanulási helyek a Budapest Schoolban}
    ...
    \begin{center}
        \scalebox{0.7}{%
            \begin{tabular}{p{3.5cm}|l|p{5cm}|p{5cm}}
                ...
                eseti külső           & modulvezető      & egy-egy foglalkozás megtartása        & a tanulásszervező hozzájárulnak és a szülők    nem ellenzik \\
                \hline
                szerződött partner    & mikroiskola      & egy-egy modul megtartása              & a tanulásszervező hozzájárulnak és a szülők    nem ellenzik  \\
                \hline
