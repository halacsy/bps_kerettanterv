...
A kerettanterv a célok eléréséhez öt \emph{kiemelt} és három \emph{integrált}  tantárgyat definiál  a moduláris tanulás tartalmi keretezéséhez. A keretezés azt értjük, hogy nyolc tantárgy határozza meg, hogy mivel kell mindenképp a Budapest School iskolákban foglalkozni, mit kell mindenképp megtanulni. 
Az egyes modulok ezen tantárgyak tanulási eredményeinek elérését támogatják.

\paragraph{Kiemelt tantárgyak}
A Budapest School kerettanterv a következő öt tantárgyat kiemeli a miniszter által kiadott kerettanterből, azzal a céllal, hogy biztosítva legyen a magyar iskolák közötti könnyű átjárhatóság, a továbbtanuláshoz szükséges ,,vitt pontok'' igazságos, könnyű és átlátható számítása és a kötelező érettségi tantárgyakra való felkészülét. A kiemelt tantárgyak elnevezésükben, céljaikban és a tartalmukban teljesen megfelelnek a miniszter által kiadott kerettantervi tantárgyaknak. Az öt tantárgy a következő
\begin{enumerate}
  \item Magyar nyelv és irodalom
  \item Történelem, társadalmi és állampolgársági ismeretek
  \item Matematika
  \item Idegen nyelv
  \item Testnevelés
\end{enumerate}
...
\paragraph{Integrált tantárgyként} \emph{három új tantárgyat} definiál a kerettanterv a miniszter által kiadott kerettanterv összes tantárgyának három nagy integrált csoportba való rendezésével. Az integrált tantárgyak önmagukban lefedik a miniszter által kiadott kerettanterv összes elvárt tanulási eredményét. Az integrált tantárgyak a következőek:
\begin{itemize}
  \item Természet- és mérnöki	tudomány, technológia és matematika (Science, Technology, Engineering, Math angol szavak alapján rövidítve STEM)
  \item Kultúra, társadalom, kommunikáció és művészetek (rövid neve KULT)
  \item Harmónia
\end{itemize}
...
\subsection[KULT]{Kultúra, társadalom, kommunikáció és művészetek}
