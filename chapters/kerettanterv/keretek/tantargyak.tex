...
A kerettanterv a célok eléréséhez öt \emph{kiemelt} és három \emph{integrált}  tantárgyat definiál  a moduláris tanulás tartalmi keretezéséhez. A keretezésen azt értjük, hogy nyolc tantárgy határozza meg, hogy mivel kell mindenképp a Budapest School iskolákban foglalkozni, mit kell mindenképp megtanulni. 
Az egyes modulok ezen tantárgyak tanulási eredményeinek elérését támogatják.

\paragraph{Kiemelt tantárgyak}
A Budapest School kerettanterv a következő öt tantárgyat kiemeli a miniszter által kiadott kerettantervből, azzal a céllal, hogy biztosítva legyen a magyar iskolák közötti könnyű átjárhatóság, a továbbtanuláshoz szükséges ,,vitt pontok'' igazságos, könnyű és átlátható számítása és a kötelező érettségi tantárgyakra való felkészülést. A kiemelt tantárgyak elnevezésükben, céljaikban és a tartalmukban teljesen megfelelnek a miniszter által kiadott kerettantervi tantárgyaknak. Az öt tantárgy a következő:
\begin{enumerate}
